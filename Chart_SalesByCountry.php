...
<table width='875' align='center' cellspacing='0' cellpadding='0'>
	...
	<?php
		...
		$strXML = "<chart caption='Sales By Country for " . $intYear . "'   palette='" . getPalette() . "' animation='" . getAnimationState() . "' formatNumberScale='0' numberPrefix='$' labelDisplay='ROTATE' slantLabels='1' seriesNameInToolTip='0' sNumberSuffix='pcs.' showValues='0' plotSpacePercent='10'>";
